    ...
    <div class="card-content">
      <div class="config-container">
        ...
        <div class="subscription-input-container">
          <input v-model="subscriptionUrl" type="text" class="subscription-input" placeholder="Enter subscription URL"
            :disabled="isLoading" @keyup.enter="addSubscription" />
            ...
            <div class="config-item-content">
              ...
              <div v-if="isManaging && managingFile === file"
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <input ref="renameInput" v-model="newFileName" class="subscription-input" :disabled="isLoading"
                    autofocus @keydown="handleKeydown" />
                </div>
                <div class="flex flex-col gap-1">
                  <label class="text-sm text-gray-700 font-medium">Subscription URL:</label>
                  <input v-model="editingSubscriptionUrl" class="subscription-input"
