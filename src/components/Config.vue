        ...
        <div class="mt-6 flex-grow overflow-y-auto" style="max-height: 600px">
          ...
          >
            ...
            <p class="text-gray-500 max-w-md">
              Add a configuration file by subscribing to a URL or selecting a
              local file
            </p>
          </div>
          ...
          >
            <div
              ...
              class="bg-white border rounded-lg p-4 cursor-pointer transition-all duration-300"
              :class="{
                'border-blue-400 bg-blue-50 shadow-sm':
                  configFiles[index] === selectedConfig,
                'border-orange-400 bg-orange-50 cursor-default':
                  isManaging && managingFile === file,
                'border-gray-200 hover:shadow-sm hover:border-gray-300 hover:transform hover:-translate-y-0.5':
                  configFiles[index] !== selectedConfig &&
                  !(isManaging && managingFile === file),
              }"
            ...
            >
              ...
              >
                <div>
                  <h4 class="text-lg font-semibold text-gray-800 mb-0">
                    Edit Configuration
                  </h4>
                </div>
