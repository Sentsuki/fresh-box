...
pub async fn health_check_singbox(
    ...
    crate::singbox::health_check_singbox(state).await
}
...
pub async fn initialize_singbox_state(
    ...
    crate::singbox::initialize_singbox_state(state).await
}
...
pub async fn get_singbox_status(
    ...
    crate::singbox::get_singbox_status(state).await
}
...
pub async fn refresh_singbox_detection(
    ...
    crate::singbox::refresh_singbox_detection(state).await
}
