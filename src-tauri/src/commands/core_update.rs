...
pub async fn cancel_core_update(
    ...
    crate::core_update::cancel_core_update(cancel).await
}
...
pub async fn get_singbox_core_status(
    ...
    crate::core_update::get_singbox_core_status(state, force_refresh).await
}
...
pub async fn activate_singbox_core(
    ...
    crate::core_update::activate_singbox_core(channel, version).await
}
...
pub async fn update_singbox_core(
    ...
    crate::core_update::update_singbox_core(app, state, cancel, channel, version).await
}
